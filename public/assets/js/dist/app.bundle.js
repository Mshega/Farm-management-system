...
exports["default"] = () => new (class User {
    ...
    async addDepartmentManager(e) {
        e.preventDefault();
        const response = await (0, fetch_1.default)('/user/add/department-manager', {
            body: {
...
exports["default"] = () => {
    oddlyjs_1.Middleware.repeat(async (next) => {
        const res = await (0, fetch_1.default)('/user/get/details/by/session');
        oddlyjs_1.Environment.put('userDetails', res.userDetails, true);
        next();
    });
};
...
const user_1 = __importDefault(__webpack_require__(/*! ./user */ "./public/assets/js/src/routes/user.ts"));
exports["default"] = () => {
    (0, base_1.default)();
    (0, user_1.default)();
};
...
/***/ "./public/assets/js/src/routes/user.ts":
/*!*********************************************!*\
  !*** ./public/assets/js/src/routes/user.ts ***!
  \*********************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
